    ...
    <div>
      ...
      <section className="projectContainer">
        ...
        <section className="contentContainer">
          ...
          <bar />
          <p> After conducting initial user research, the team <em>synthesized</em> all of the <em>collected data</em>. We began with a <em>mind map</em>,
          ...
          <div>
            <div>
              <img src="" alt="beep boop mind map" width="" height="" />
              <h4>HMW create a simple user flow to solidify our main features while also encouraging engagement?</h4>
            </div>
            <img src="" alt="persona" width="" height="" />
          </div>
        </section>
        <section className="contentContainer">
          <h2>Ideating through sketches</h2>
          <bar />
          <p> The team moved forward with our sketches using the <em>Crazy 8 sketching method.</em> The each member of the design team
          ...
          <div className="centeredImages">
            <img src="" alt="crazy 8 sketches" width="" height="" />
            <img src="" alt="crazy 8 sketches" width="" height="" />
          </div>
        </section>
        <section className="contentContainer">
          ...
          <bar />
          <p> Bringing the sketches to life began with greyscales. We <em>initially</em> thought that the <em>rofile</em> would just be an <em>overlay</em>,
        ...
        <section className="contentContainer">
          ...
          <div className="centeredImages">
            <img src="" alt="orange I" width="" height="" />
            <img src="" alt="orange II" width="" height="" />
            <img src="" alt="blue I" width="" height="" />
            <img src="" alt="blue II" width="" height="" />
            <img src="" alt="grey" width="" height="" />
          </div>
          <div className="centeredRowContiner">
            <div className="">
              <img src="" alt="high-fi I" width="" height="" />
              <p className="caption">landing home page with the neomorphism components and BeepBoop color palete </p>
            </div>
            <div>
              <img src="" alt="high-fi II" width="" height="" />
              <p className="caption">profile page using the BeepBoop colors on components </p>
            </div>
            <div>
              <img src="" alt="high-fi III" width="" height="" />
