    ...
    <div>
      ...
      <section>
        <div>
          ...
          <div />
          <p>With a large market already in the field of chess when looking for competitiors we focused
      ...
      <section>
        <div>
          ...
          <div>
            <img src="" alt="" width="" />
            <p>Our target user was developed after conducting 8 user interviews. </p>
          </div>
        </div>
        <h1>“When playing chess you are living in a shared reality. The key to that reality is skill.”</h1>
        <img src="" alt="" width="" />
      ...
      <section>
        ...
        <p>As we prepared to share with the rest of the DALI Lab, our team found ourselves stuck on betting functionality. Users were allowed to choose a betting amount; however,
      ...
      <section>
        ...
        <div />
        <p>Reflecting on the challenge of solidifying a solid UX for this chess betting project was an enormous feat as neither I nor my design partner and mentor had any chess or betting expereince.
      ...
      <section>
        ...
        <div>
          ...
          <div>
            <img src="" alt="" width="" />
            <p>Initial Dashboard</p>
          </div>
          <div>
            <img src="" alt="" width="" />
            <p>Neon Iteration: Using bright neon gradients to make the most use of the dark UI</p>
          </div>
          <div>
            <img src="" alt="" width="" />
            <p>Pastel Iteration: Using pastels and large graphics to engage our target audience</p>
          </div>
        </div>
      ...
      <section>
        ...
        <div>
          ...
          <p>final implementation of neon gradients and betting currency </p>
        </div>
      </section>
      <section>
        <h2>UI Recap</h2>
